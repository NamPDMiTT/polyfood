...
" />
                         ...
                         <div class="form__group flex flex-col ">
                             ...
                             <input type="text" class="form__input-add__prodcut shadow-2xl border border-gray-200 focus:outline-none text-xs sm:text-sm md:text-base lg:text-base bg-gray-100 mt-2 p-2 px-3  rounded-md text-gray-500 " name="product_name" id="name" placeholder="Product name" value="" />
                         ...
                         <div class="form__group flex flex-col">
                             ...
                             <input type="file" name="image" id="image" placeholder="Image" class="mt-2 p-2 px-3  shadow-2xl border border-gray-200 focus:outline-none text-xs sm:text-sm md:text-base lg:text-base bg-gray-100 rounded-md text-gray-500" value="" />
                             <span class="text-red-500 text-xs mt-3 font-medium ">
                                 <?php
                         ...
                         <div class="form__group flex flex-col">
                             ...
                             <input type="number" min="0" class="form__input-add__prodcut mt-2 p-2 px-3  shadow-2xl border border-gray-200 focus:outline-none text-xs sm:text-sm md:text-base lg:text-base bg-gray-100 rounded-md text-gray-500" name="price" id="price" placeholder="Price" value="" />
                             <span class="text-red-500 text-xs mt-3 font-medium ">
                                 <?php
                         ...
                         <div class="form__group flex flex-col">
                             ...
                             <input type="number" min="0" class="form__input-add__prodcut mt-2 p-2 px-3  shadow-2xl border border-gray-200 focus:outline-none text-xs sm:text-sm md:text-base lg:text-base bg-gray-100 rounded-md text-gray-500" name="discount" id="discount" placeholder="Discount" value="" />
...
=======
<?php $items=categories_select_all() ?>
<article class="w-[85%]">
    <header style="border-radius: 10px; background: #fff; box-shadow: 35px 35px 70px #bebebe,
-35px -35px 70px #ffffff;
" class="w-full h-[60px] flex items-center justify-between px-5 py-2">
