...
#bebebe, -35px -35px 70px #ffffff; "
          ...
          >
            <section class="list__accounts w-full">
              ...
              <form
                action="index.php?action=deleteSelectedComment"
                method="post"
              >
                  ...
                  <table class="w-full text-center rounded-md shadow-md my-3">
                    ...
                    <tbody>
                      <tr class="border-t-2 border-dashed">
                        ...
                        <td class="p-2 w-20 ">
                          <p
                            class="text-xs text-gray-900 truncate w-32 overflow-hidden"
                          >
                            ' . $content . '
                          </p>
                        </td>
                        ...
                        <td class="p-2">
                          <img
                            src="../uploads/comment/' . $comment_img . '"
                            alt=""
                            class="w-16 h-16 block mx-auto"
                          />
                        </td>
                        <td class="p-2">
                          <p class="text-xs text-gray-900">
                        ...
                        <td
                          class="px-2 mt-7 whitespace-nowrap flex gap-3 items-center justify-center"
                        >
                          <a
                            href="' . $deleteCommentUrl . '"
                ...
                <div
                  class="list__accounts-table--button w-full px-5 mt-7 flex justify-center gap-5"
                >
                  <label
                    for="checkAll"
                    style="text-shadow: 0.6px 0.6px 0 #fff; color: #61677c; box-shadow:
