...
<tr class="border-t-2 border-dashed">
                <td class="p-2 whitespace-nowrap">
                  <input type="checkbox" name="feedback_id[]" value="<?= $feedback_id ?>" class="checkbox" />
                </td>
                <td class="p-2 whitespace-nowrap">
                ...
                <td class="p-2 whitespace-nowrap">
                  <p class="text-xs text-gray-900">
                    <img src="<?= $CONTENT_URL ?>/images/feedbacks/<?= $image ?>" width="80" height="80" alt="">
                  </p>
                </td>
                <td class="p-2 whitespace-nowrap">
                  <p class="text-xs text-gray-900">
                ...
                <td class="px-2 mt-7 whitespace-nowrap flex gap-3 items-center justify-center">
                  <a href="index.php?btn_delete&feedback_id=<?=$feedback_id?>&product_id=<?=$product_id?>" class="text-indigo-600 hover:text-indigo-900">Xóa
                  </a>
                </td>
              </tr>
                <?php } ?>
