...
" value="" />
                     ...
                     <div class="form__group flex flex-col ">
                         ...
                         <input type="text" class="form__input-add__prodcut shadow-2xl border border-gray-200 focus:outline-none text-xs sm:text-sm md:text-base lg:text-base bg-gray-100 mt-2 p-2 px-3  rounded-md text-gray-500 " name="category_name" id="name" placeholder="Product name" value="" />
                     </div>
