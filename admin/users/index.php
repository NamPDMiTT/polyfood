...
if(exist_param("btn_insert")){
    ...
    try {
        insert_users($user_name, $password, $email, $phone, $image, $role);
        unset($user_name, $password, $email, $phone, $image, $role);
    ...
    try {
        update_users($user_name, $password, $email, $phone, $image, $role, $user_id);
