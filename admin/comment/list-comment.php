...
#bebebe, -35px -35px 70px #ffffff; " class="w-full  p-5 mt-5 bg-gray-100">
       <section class="list__accounts w-full">
           ...
           <form action="index.php?action=deleteSelectedComment" method="post">
                       ...
                       <tbody>
                           ...
                           <?php
                            foreach ($commentList as $comment) {
                                extract($comment); // extract() sẽ tạo ra các biến từ key của mảng - database
                                $deleteCommentUrl = "index.php?action=deleteComment&id=" . $id_comment;
                                echo '<tr class="border-t-2 border-dashed">
                          <td class="p-2 whitespace-nowrap">
                                    <input type="checkbox" name="checkbox[]" value="' . $id_comment . '" class="checkbox"/>
                                </td>
 <td class="p-2 whitespace-nowrap">
                           ...
                           <td class="p-2 whitespace-nowrap">
                              ...
                              <td class="p-2">
                               <img src="../uploads/comment/' . $comment_img . '" alt="" class="w-16 h-16 block mx-auto" />
                           </td>
                           <td class="p-2">
                               <p class="text-xs text-gray-900">
                                        ' . $date_comment . '
                           ...
                           <td class="px-2 mt-7 whitespace-nowrap flex gap-3 items-center justify-center">
                                  <a href="' . $deleteCommentUrl . '" class="text-indigo-600 hover:text-indigo-900"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
