...
>
  <div class="product__img">
    <img
      class="rounded-lg w-24 h-24 object-cover object-center"
      src="<?= $CONTENT_URL ?>/images/products/<?= $image ?>"
      alt=""
    />
  </div>
  <div class="product__info flex flex-col gap-1">
    ...
    <p class="text-gray-600 text-xs">Đơn giá : <?= number_format($price*(1-$discount/100), 0, '', '.') ?>đ</p>
...
<div
  class="list__porduct__orded__item__user  rounded-lg p-5 border-[3px] border-dashed"
>
  <div class="list__porduct__orded__item__user__info flex gap-5">
    <div class="user__info">
      <h1 class="text-xl font-semibold text-gray-700">Thông tin người nhận</h1>
      <p class="text-gray-600 text-sm font-bold">
        Họ tên : <span class="font-normal"><?= $name ?></span>
      </p>
      <p class="text-gray-600 text-sm font-bold">
  ...
  <div class="list__porduct__orded__item__user-check mt-2 flex justify-center items-center gap-2">
    <button type="submit" name="btn_confirm" class="bg-green-500 text-white text-sm font-semibold px-3 py-2 rounded-lg"
    >
        Xác nhận
    </button>
    <button type="submit" name="btn_cancel" class="bg-green-500 text-white text-sm font-semibold px-3 py-2 rounded-lg"
    >
        Hủy
    </button>
  </div>
