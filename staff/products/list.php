                    ...
                    <table class="w-[600px] mx-auto text-center rounded-md shadow-md my-3">
                        <thead class="boder bg-gray-200 px-2 rounded-t-md">
                            <tr>
                                ...
                                <th class="whitespace-nowrap text-xs  px-2 py-2 font-medium">
                                    Sản phẩm
                                </th>
                                <th class="whitespace-nowrap text-xs  px-2 py-2 font-medium">
                                    Thực đơn
                                ...
                                <th class="whitespace-nowrap text-xs  px-6 py-2 font-medium">
                                    Thao tác
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr class="border-t-2 border-dashed">
                                ...
                                <td class="p-2 whitespace-nowrap">
                                    <img src="<?= $CONTENT_URL ?>/images/products/<?= $image ?>" width="100"
                                        height="100" alt="">
                                </td>
                                <td class="limited__content-4 px-2">
                                    <p class="text-xs text-gray-900">
                                        <?= $detail ?>
                                    </p>
                                </td>
                                ...
                                <td class="px-2  whitespace-nowrap flex gap-3 items-center justify-center">
