...
focus:border-orange-500 focus:outline-none"
            ...
            <div
              class="bg-white payment__method flex gap-4 p-5 border border-dashed"
            >
            ...
            <h2
              class="product__checkout text-xl text-orange-500 flex items-center gap-2 mt-4
"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div
              class="bg-white product__checkout w-full flex justify-center flex-col gap-2 lg:pl-5"
            >
              <table class="bg-white table-auto mx-auto hidden sm:block">
                <thead>
                  <tr>
                    <th
                      class="px-4 py-2 text-left font-semibold text-gray-600 text-xs uppercase"
                    >
                      Products details
                    </th>
                    <th
                      class="px-4 py-2 font-semibold text-gray-600 text-xs uppercase"
                    >
                      Quantity
                    </th>
                    <th
                    ...
                    <td class="px-4 py-2 w-[40%]">
                      <div class="flex">
                        <div class="w-20 h-auto">
                          <img
                            src="https://cdn.tgdd.vn/Products/Images/42/220533/samsung-galaxy-a52-5g-128gb-1-400x460.png"
                            alt=""
                            class="w-26 h-auto"
                          />
                        </div>
              ...
              <div
                class="list__product__cart-mobile flex flex-col sm:hidden  gap-5"
              >
                <div
                  class="item__prouduct__cart-mobile border-b-[3px] border-dashed pb-2 flex gap-3"
                >
                  <img src="' . $imageSrc . '" class="w-24 h-24 object-cover" />
                  <div
                    class="item__product__cart-mobile--info flex flex-col justify-between"
                  >
              ...
              <div
                class="total__price--note flex flex-col  gap-3 p-2 sm:p-5 px-5 border border-dashed"
              >
...
focus:border-orange-500 focus:outline-none"
                ...
                <div
                  class="total__price flex justify-between gap-4 items-center sm:mt-4"
                >
              ...
              <div
                class="form__group--oder w-full flex flex-col sm:flex-row items-center justify-between gap-3 mt-3 mb-10 lg:mb-20"
              >
                ...
                <button
                  name="order"
                  class="form__input--submit w-full sm:w-1/4  bg-orange-600 text-white p-3 rounded-sm
focus:outline-none"
                >
                  Đặt hàng
                </button>
