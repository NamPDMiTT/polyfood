...
?> <div class="container mx-auto mt-10">
    <main class="w-full px-8 mt-14 md:px-14 lg:px-24">
        ...
        const countdown = setInterval(() => {
            if (time > 0) {
                time--
                document.getElementById('countdown__next__page__time').innerHTML = time
            } else {
        ...
        <img class="w-full h-auto"
            src="https://www.revechat.com/wp-content/uploads/2022/06/image_2022_06_09T10_44_05_419Z.png" alt="" />
