...
?> <div class="container mx-auto mt-10">
    <main class="w-full px-8 mt-14 md:px-14 lg:px-24">
        <div style="
            ...
            " id="countdown__next__page" class="p-5 mx-auto text-center rounded-lg w-fit">
            <h1 class="text-xl font-semibold text-center text-gray-700">Đặt hàng thành công !</h1>
            <p class="mt-2 text-center text-gray-500">
                Bạn sẽ được chuyển đến danh sách đơn hàng sau
                <span id="countdown__next__page__time" class="font-bold text-indigo-500">5</span> giây
            </p>
        </div>
        ...
        <div class="flex flex-col justify-between px-5 order__info sm:flex-row-reverse lg:px-20">
            <div class="mt-5 order__info__title">
                ...
                <p class="mt-2 text-sm text-gray-500">Ngày đặt : </p>
            </div>
            <div class="mt-5 order__info__address">
                <h1 class="text-lg font-bold text-gray-700 sm:text-2xl">
                    Thông tin người nhận
                </h1>
                <p class="mt-1 text-lg text-gray-500">Lê Công Tiến</p>
                <p class="mt-2 text-sm text-gray-500">096 5067842</p>
            </div>
        </div>

        <div class="my-5 order__products lg:px-20"></div>

        <div class="flex flex-col justify-between w-full gap-5 px-5 mt-5 payment__method-total__price sm:flex-row lg:px-20">
            <div class="flex flex-col justify-between sm:flex-row payment__method sm:gap-5">
                <h1 class="text-base font-bold text-gray-700 sm:text-lg">
                    Phương thức thanh toán :
                </h1>
                <p class="text-gray-500">Tiền mặt</p>
            </div>
        ...
        <div class="flex w-full my-10 cancel-oder sm:justify-end">
            <a href="index.php?action=index.php" class="hidden mt-5 text-sm font-semibold text-indigo-600 lg:flex">
