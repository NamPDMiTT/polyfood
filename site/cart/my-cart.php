                    ...
                    <div class="product__item flex justify-between items-center rounded-lg border-[3px] border-dashed p-3 relative">
                        <div class="flex gap-2 sm:gap-5">
                            <div class="flex product__img">
                                <img class="rounded-lg w-[110px] h-[110px] object-cover object-center" src="<?= $CONTENT_URL ?>/images/products/<?= $item['image'] ?>" alt="" />
                            </div>
                            <div class="flex flex-col justify-between px-2 product__info">
                                ...
                                <form action="index.php?btn_re_quantity" method="POST">
                                    <div class="flex">
                                        <button style="box-shadow: 0 8px 32px 0 rgba(31, 38, 135, 0.37)" name="choose" value="0" class="bg-white rounded-md">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-gray-500">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M18 12H6" />
                                            </svg>
                                        </button>

                                        <input id="quantity" name="quantity" class="w-10 mx-2 text-xs text-center border rounded-md sm:text-sm" type="text" value="<?= $item['quantity'] ?>" />
                                        <input type="hidden" id="product_id" name="product_id" value="<?= $item['product_id'] ?>" />
                                        <button style="box-shadow: 0 8px 32px 0 rgba(31, 38, 135, 0.37)" name="choose" value="1" class="bg-white rounded-md">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-gray-500">
                        ...
                        <form class="absolute top-0 right-0 product__delete sm:p-2">
                            <button type="submit" name="btn_delete_cart" class="btn__delete__cart">
