      ...
      <aside class="">
          <div style="background-image: url('../IMG/anh-bia.jpg')" class="shadow rounded-lg">
              <div class="flex flex-col gap-1 text-center items-center backdrop-blur-sm p-16">
                  <img class="h-32 w-32 bg-white p-2 rounded-full shadow mb-4" src="../../content/images/posts/tien.jpg" alt="" />
                  <p class="font-semibold text-white">Lê Công Tiến</p>
                  <p class="text-white text-xs">congtiendev</p>
