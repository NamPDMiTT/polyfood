        ...
        <div class="form__login my-10 w-full flex justify-center">
          <form action="update-account.php" method="post" enctype="multipart/form-data" class="form__login--content w-[300px] sm:w-[500px]  flex flex-col  gap-4">
            ...
            <div class="form__group flex flex-col gap-2">
              ...
              <input type="file" name="image_upload" id="image_upload" class="form__input  text-xs border border-gray-700  p-[9px] w-full rounded-sm focus:border-orange-500 focus:outline-none" placeholder="image" />
            ...
            <div class="form__group flex flex-col justify-center items-center gap-3">
              ...
              <button type="reset" name="btn_reset" class="text-white bg-orange-600 p-2 rounded-sm w-full sm:w-[100px] text-center">
                RESET
              </button>
            </div>
            <!--Default value-->
