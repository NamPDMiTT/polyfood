          ...
          <form action="sign-up.php" method="post" enctype="multipart/form-data" class="form__login--content w-[300px] sm:w-[500px]  flex flex-col  gap-4">
            ...
            <div class="form__group flex flex-col gap-2">
              ...
              <input type="text" name="user_name" id="username" class="form__input  text-xs border border-gray-700  p-3 w-full rounded-sm
                  focus:border-orange-500 focus:outline-none" placeholder="Username" value="" />
              <span class="text-red-500 text-xs">
                <?php
            ...
            <div class="form__group flex flex-col gap-2 ">
              ...
              <input type="password" name="password" id="password" class="form__input  text-xs border border-gray-700  p-3 w-full rounded-sm 
                  focus:border-orange-500 focus:outline-none" placeholder="Password" value="" />
              <span class="text-red-500 text-xs">
                <?php
            ...
            <div class="form__group flex flex-col gap-2">
              ...
              <input type="password" name="confirm_password" id="confirm_password" class="form__input  text-xs border border-gray-700  p-3 w-full rounded-sm focus:border-orange-500 focus:outline-none" placeholder="Confirm password" value="" />
              <span class="text-red-500 text-xs">
                <?php
            ...
            <div class="form__group flex flex-col gap-2">
              ...
              <input type="email" name="email" id="email" class="form__input  text-xs border border-gray-700  p-3 w-full rounded-sm focus:border-orange-500 focus:outline-none" placeholder="Email" value="" />
              <span class="text-red-500 text-xs">
                <?php
