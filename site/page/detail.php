...
<body>
    ...
    <section class="max-w-6xl mx-auto mt-10">
        ...
        <div class="grid md:grid-cols-2 gap-12 px-6">
            ...
            <div class="">
                <div class="font-bold text-5xl font text-orange-600">Bún bò </div>
                <div class="flex items-center space-x-2 py-4 ">
                    <p class="text-orange-600">★★★★</p>
                    <p class="text-black">|</p>
                    <p class="font ">7 Customer Reviews</p>
                </div>
                <div class="text-3xl font text-orange-600 flex space-x-2">
                    <strike class="text-zinc-500 text-xl">₫.9999</strike>
                     <p class="text-3xl"> - ₫.000</p>
                ...
                <section class="max-w-6xl mx-auto">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 py-4">
                        <div class="p-4 shadow__products  rounded-2xl bg-white space-y-2">
                            ...
                            <button id="them" class="btn__add w-full bg-orange-600 text-white px-2 py-2 rounded hover:bg-red-500">
                                Thêm vào giỏ
                              </button>
