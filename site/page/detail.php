...
Đăng ký</button>";
        ...
        <div class="grid md:grid-cols-2 gap-12 px-6">
            ...
            <div class="">
                <form action="../cart/index.php?btn_order" method="POST">
                    ...
                    <div class="font-bold text-5xl  text-orange-600"><?= $items['product_name'] ?></div>
                    <div class="flex items-center space-x-2 py-4 ">
                        ...
                        <p class=" "><?= $count ?> Customer Reviews</p>
                    </div>
                    ...
                    <div class=" text-2xl font-bold py-4">Ưu đãi</div>
                    <div class="flex items-center space-x-2">
                        <span class="bg-orange-600 py-2 px-0.5"></span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-calendar-check text-orange-600" viewBox="0 0 16 16">
                            <path
                                d="M10.854 7.146a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7.5 9.793l2.646-2.647a.5.5 0 0 1 .708 0z" />
                            <path
                                d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5zM1 4v10a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V4H1z" />
                        </svg>
                        <p class="text-orange-600">Đổi trả dễ dàng trong 2 giờ nếu bạn đổi ý</p>
                    </div>
                    <div class="flex items-center space-x-2 py-2">
                        <span class="bg-orange-600 py-2 px-0.5"></span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-tags text-orange-600" viewBox="0 0 16 16">
                            <path
                                d="M3 2v4.586l7 7L14.586 9l-7-7H3zM2 2a1 1 0 0 1 1-1h4.586a1 1 0 0 1 .707.293l7 7a1 1 0 0 1 0 1.414l-4.586 4.586a1 1 0 0 1-1.414 0l-7-7A1 1 0 0 1 2 6.586V2z" />
                            <path
                                d="M5.5 5a.5.5 0 1 1 0-1 .5.5 0 0 1 0 1zm0 1a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zM1 7.086a1 1 0 0 0 .293.707L8.75 15.25l-.043.043a1 1 0 0 1-1.414 0l-7-7A1 1 0 0 1 0 7.586V3a1 1 0 0 1 1-1v5.086z" />
                        </svg>
                        <p class="text-orange-600 ">Gọi món sớm, có hàng sớm :></p>
                    </div>
                    <button class="bg-orange-600 text-white  py-2 px-8 items-center flex  rounded-xl">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            class="bi bi-bag-x-fill w-[16px] h-[16px] " viewBox="0 0 16 16">
    ...
    <section class="max-w-6xl mx-auto mt-20">
        <div class="flex justify-center items-center space-x-4 button-box">
            <div id="btn"
                class="inlinde-block md:mr-44  text-xl text-center rounded-xl md:w-[90px] md:h-[48px] border-red-500 bg-orange-500">
            </div>
            <button type="button" class="toggle-btn" onclick="leftClick()"><span id="trai"
                    class="inline-block text-xl  py-2 px-8  text-white  rounded-xl  sili ">Mô tả</span></button>
            <button type="button" class="toggle-btn" onclick="rightClick()"><span id="phai"
                    class="inline-block  text-xl  py-2 px-8  text-red-500 rounded-xl  ">Nhận xét ( <?= $count ?>
                    )</span></button>
        </div>
            ...
            <form action="index.php?feedback" method="post" enctype="multipart/form-data">
                ...
                <div class=" grid grid-cols-[100px,auto]  mt-10">
                    <div class="rounded-full flex items-center gap-5 rounded-2 rounded-red-500 w-[100px] h-[48px]">
                        <img src="<?= $CONTENT_URL . '/images/users/' ?><?= isset($_SESSION['user']) ? $_SESSION['user']['image'] : 'user.png' ?>"
                            alt="" class="rounded-full w-[48px] h-[48px]">
                    ...
                    <div class="space-y-2">
                        ...
                        <textarea id="note" name="note" placeholder="Điền đánh giá ...."
                            class="md:w-[612px] md:h-[97px] border-2 rounded px-4 py-1"></textarea>
                        <br>
                        <?php
    ...
    <section class="max-w-6xl mx-auto">
        <h1 class="text-center font-bold text-3xl text-orange-600">Có thể bạn cũng thích</h1>
