                ...
                <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
                    <a href="<?= $SITE_URL ?>/page/product.php?category_id=<?= $category_id ?>">
                        <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg">
                            <img alt="team" class="w-16 h-16 object-cover object-center flex-shrink-0 mr-4" src="<?= $CONTENT_URL ?>/images/categories/<?= $category_image ?>" />
                            <div class="flex-grow">
                    ...
                    <div class="rounded-xl">
                        <a href="<?= $SITE_URL ?>/page/detail.php?product_id=<?= $product_id ?>">
                            <div class="product__img">
                                <img class="w-full min-w-[200px] h-[150px] lg:h-[200px] object-cover object-center rounded-t-xl" src="<?= $CONTENT_URL ?>/images/products/<?= $image ?>" alt="content" />
                            </div>
                        </a>
